import { ChangeEvent, FocusEventHandler, useEffect, useState, useContext } from 'react'
...
const CartItem = ({
  ...
  const handleChange = async ({
    ...
    await dispatch({ type: 'CART_ADD_ITEM', payload: { ...item, quantity: Number(value) } });
  ...
  const increaseQuantity = async (n = 1) => {
    ...
    dispatch({ type: 'CART_ADD_ITEM', payload: { ...item, quantity: val } });
