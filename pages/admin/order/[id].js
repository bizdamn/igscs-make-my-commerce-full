...
function Order({ params }) {
  ...
  }, [order, successPay, successDeliver,router,adminStoreInfo,orderId]);
    ...
    return actions.order.capture().then(async function (details) {
      try {
        ...
        const { data } = await axios.put(
          `/api/admin/orders/${order._id}/pay`,
          details,
          {
            headers: { authorization: `Bearer ${adminStoreInfo.token}` },
          }
  ...
  return (
    <Layout>
      <Typography textAlign="center" component="p" variant="h4" sx={{ fontWeight: 900 }} >
        Order {orderId}
      </Typography>
      {loading ? (
        <CircularProgress />
        ...
        <Grid
          ...
          <Grid item md={3} xs={12}>
            ...
            <Card className={classes.section}>
              <List>
                <ListItem>
                  <Typography component="p" variant="h5" sx={{ fontWeight: 900 }} >Order Summary</Typography>
                </ListItem>
                <ListItem>
                  <Grid container>
                    <Grid item xs={6}>
            ...
            <Card className={classes.section}>
              <List>
                ...
                <ListItem>  <Typography component="p"  >{paymentMethod}   </Typography></ListItem>
                <ListItem>
                  <Typography component="p"  > <b> Status: </b>{isPaid ? `Paid at ${paidAt}` : 'Not Paid'}   </Typography>
                </ListItem>
              </List>
            </Card>
          </Grid>
