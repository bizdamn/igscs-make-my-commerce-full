...
export async function getServerSideProps(ctx) {
  ...
  await db.connect();
  const physical_products = await PhysicalProduct.find({ storeID: JSON.parse(cookies.adminStoreInfo)._id }).lean();
  const digital_products = await DigitalProduct.find({ storeID: JSON.parse(cookies.adminStoreInfo)._id }).lean();
  await db.disconnect();
